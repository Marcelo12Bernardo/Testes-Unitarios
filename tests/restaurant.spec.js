...
describe('10 - Implemente a função `createMenu`, bem como seus casos de teste', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    let objetoRetornado = createMenu(objetoTeste);
    ...
    // ```
    expect(objetoRetornado.fetchMenu()).toEqual({"drink": {}, "food": {}});
    ...
    // ```
    expect(objetoRetornado.fetchMenu()).toEqual(objetoTeste);
    ...
    objetoRetornado.consumption = []; //Zera o consumo
    ...
    objetoRetornado.order('agua');
    objetoRetornado.order('coxinha');
    expect(objetoRetornado.pay()).toBeCloseTo(13.2);
