...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contendo os valores esperados', () => {
    ...
    expect(circle(12).hasOwnProperty('radius','area','circumference')).toBeTruthy();
    expect(circle()).toBeUndefined();
    expect(circle(2).circumference).toBe(12.56);
    expect(circle(3).area).toBe(28.259999999999998);
    expect(Object.values(circle(3))).toEqual(expect.arrayContaining([28.259999999999998,18.84,3]));
